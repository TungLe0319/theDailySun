...
const Schema: z.ZodType<Prisma.ProductUpsertWithWhereUniqueWithoutCartInput> = z
  .object({
...
export const ProductUpsertWithWhereUniqueWithoutCartInputObjectSchema = Schema;
