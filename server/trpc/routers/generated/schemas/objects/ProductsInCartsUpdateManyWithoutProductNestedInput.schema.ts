...
const Schema: z.ZodType<Prisma.ProductsInCartsUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductsInCartsUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
