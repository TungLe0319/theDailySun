...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutCartInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutCartInputObjectSchema =
  Schema;
