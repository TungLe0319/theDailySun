...
const Schema: z.ZodType<Prisma.ProductsInCartsUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductsInCartsUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
