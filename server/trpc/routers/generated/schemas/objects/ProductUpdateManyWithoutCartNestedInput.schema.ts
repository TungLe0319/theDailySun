...
const Schema: z.ZodType<Prisma.ProductUpdateManyWithoutCartNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ProductUpsertWithWhereUniqueWithoutCartInputObjectSchema),
        z
          .lazy(() => ProductUpsertWithWhereUniqueWithoutCartInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => ProductUpdateWithWhereUniqueWithoutCartInputObjectSchema),
        z
          .lazy(() => ProductUpdateWithWhereUniqueWithoutCartInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const ProductUpdateManyWithoutCartNestedInputObjectSchema = Schema;
